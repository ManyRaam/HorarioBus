...
import com.example.busschedule.data.DaoBus
import kotlinx.coroutines.flow.Flow


class BusScheduleViewModel(private val busScheduleDao: DaoBus): ViewModel() {
    ...
    companion object {
        val factory : ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                BusScheduleViewModel(application.database.DaoBus())
            }
        }
    }
}
